/**
 * n8n Workflow Deployment Test (Final Minimal)
 * Tests deployment with exact minimal format from existing workflows
 */
...
// Minimal test workflow matching existing structure exactly
const TEST_WORKFLOW = {
  name: `Clixen Test - ${Date.now()}`,
  active: false,
  nodes: [
    {
      id: "start-node",
      ...
      parameters: {
        values: {
          string: [
            {
              name: "message",
              value: "Clixen deployment test successful!"
            }
          ]
        }
      }
...
async function testFinalMinimalN8nDeployment() {
  console.log('🚀 Starting Final Minimal n8n Workflow Deployment Test\n');
  ...
  try {
    ...
    // Step 4: Create Test Workflow (Minimal Format)
    if (results.n8nApiAccess.success) {
      ...
      try {
        ...
        console.log('   Using exact minimal format from existing workflows');
  ...
  console.log('\n🎉 Final Minimal n8n Deployment Test Results');
  console.log('===============================================');
...
// Run the final minimal deployment test
testFinalMinimalN8nDeployment()
  .then(results => {
    console.log('\n🏁 Final Minimal n8n Deployment Test Completed');
...
export { testFinalMinimalN8nDeployment };